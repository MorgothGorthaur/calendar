...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    List<Event> checkIfParticipantContainsEventWithId(Long eventId, String email);
    ...
    List<Event> checkIfParticipantContainsEventWithSameTimeAndDescription(LocalDateTime startTime, LocalDateTime endTime, String description, String email);
}
